...
function showTurnDown() {
  screen.innerHTML = `
    <div class="fcard rejected">
      ...
      <p>This lab starts from there. A free course will get you further, faster, than eight weeks here would right now — and I'd rather send you there than take a seat that wouldn't help yet.</p>
